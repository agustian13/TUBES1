...
$doc->addScript($this->baseurl . '/templates/' . $this->template . '/scripts/jquery_no_conflict.js', 'text/javascript');
$doc->addScript($this->baseurl . '/templates/' . $this->template . '/scripts/jquery.flexslider-min.js', 'text/javascript');
?>
